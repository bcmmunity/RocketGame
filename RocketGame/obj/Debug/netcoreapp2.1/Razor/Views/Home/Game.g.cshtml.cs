#pragma checksum "C:\Users\Никита Кураев\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3d80b7e247654a40735ed728e3b37988e09183f4"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3d80b7e247654a40735ed728e3b37988e09183f4", @"/Views/Home/Game.cshtml")]
...
<style>
	...
	.ft {
		...
		bo");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "f78d0c1886a94074bd19cc77fe2587b4", async() => {
            }
            );
	...
	function selectTeam() {
		$.ajax({
			...
			success: function (result) {
				...
				$(""#teams"").append(""<span class='btn' onclick='$(\""#moves\"").show();$(\""#teams\"").hide();'>"" + Отменить + ""</span></br></br>"");
			}
		});
	}
