#pragma checksum "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6c258a393ae40d2f5fb67a589240d82fc607764e"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6c258a393ae40d2f5fb67a589240d82fc607764e", @"/Views/Home/Game.cshtml")]
...
#line 8 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml"
             Write(ViewBag.nickname);

#line default
#line hidden
            EndContext();
            BeginContext(190, 949, true);
            WriteLiteral(@"</h3>
...
#line 36 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml"
            Write(ViewBag.key);
...
");
            EndContext();
#line 62 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml"
...
#line hidden
            ...
            WriteLiteral("\t\t\t\t<tr>\r\n\t\t\t\t\t<th");
            EndContext();
            BeginWriteAttribute("id", " id=\"", 1957, "\"", 1966, 2);
            WriteAttributeValue("", 1962, "0-", 1962, 2, true);
#line 65 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml"
...
#line 66 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml"
...
#line hidden
            ...
            WriteLiteral("\r\n\t\t\t\t\t</th>\r\n\t\t\t\t\t<th");
            EndContext();
            BeginWriteAttribute("id", " id=\"", 2069, "\"", 2078, 2);
            WriteAttributeValue("", 2074, "1-", 2074, 2, true);
#line 71 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml"
...
#line default
#line hidden
            BeginContext(2139, 242, true);
            WriteLiteral("\t\t</tbody>\r\n\t</table>\r\n\r\n\t<div id=\"content\">\r\n\t</div>\r\n</div>\r\n\r\n<script>\r\n\r\n\tsetInterval(metod, 7000);\r\n\r\n\tfunction metod() {\r\n\t\t$.ajax({\r\n\t\t\ttype: \"GET\",\r\n\t\t\turl: \"/Game/Stats\",\r\n\r\n\t\t\tsuccess: function (result) {\r\n\r\n\t\t\t\tfor (var i = 0; i < ");
            EndContext();
            BeginContext(2382, 9, false);
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "0b24d6e7e1db4b5da6cb8788a870e4b9", async() => {
            }
            );
...
#line hidden
            EndContext();
            BeginContext(5665, 194, true);
            WriteLiteral(" },\r\n\r\n\t\t\tsuccess: function (result) {\r\n\t\t\t\tif (result) {\r\n\r\n\t\t\t\t\tif (!checkk) {\r\n\t\t\t\t\t\treturn;\r\n\t\t\t\t\t}\r\n\r\n\t\t\t\t\t$.ajax({\r\n\t\t\t\t\t\ttype: \"GET\",\r\n\t\t\t\t\t\turl: \"/Game/RocketCheck\",\r\n\t\t\t\t\t\tdata: { Key: ");
            EndContext();
            BeginContext(5860, 11, false);
#line 282 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml"
                                Write(ViewBag.key);

#line default
#line hidden
            EndContext();
            BeginContext(5871, 276, true);
            WriteLiteral(@" },
...
#line 297 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml"
                                Write(ViewBag.key);

#line default
#line hidden
            EndContext();
            BeginContext(6159, 1308, true);
            WriteLiteral(@" },
...
#line 360 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml"
                    Write(ViewBag.key);

#line default
#line hidden
            EndContext();
            BeginContext(7479, 754, true);
            WriteLiteral(@" },
	...
	function makeMove() {
		$.ajax({
			...
			data: { Type: move, Key: ");
            EndContext();
            BeginContext(8234, 11, false);
#line 387 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml"
                                Write(ViewBag.key);

#line default
#line hidden
            EndContext();
            BeginContext(8245, 970, true);
	...
	function Confirme() {
		...
		$.ajax({
			...
			data: { Key: ");
            EndContext();
            BeginContext(9216, 11, false);
#line 418 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml"
                    Write(ViewBag.key);

#line default
#line hidden
            EndContext();
            BeginContext(9227, 431, true);
            WriteLiteral(@" },
			...
			success: function (result) {
				if (result) {
					...
					$.ajax({
						...
						data: { Key: ");
            EndContext();
            BeginContext(9659, 11, false);
#line 442 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml"
                                Write(ViewBag.key);

#line default
#line hidden
            EndContext();
            BeginContext(9670, 276, true);
            WriteLiteral(@" },
					...
					$.ajax({
						...
						data: { Key: ");
            EndContext();
            BeginContext(9947, 11, false);
#line 457 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Home\Game.cshtml"
                                Write(ViewBag.key);

#line default
#line hidden
            EndContext();
            BeginContext(9958, 1414, true);
            WriteLiteral(@" },
