#pragma checksum "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Tick\Game.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c5e4c7a0f7a2587fa83c4f59d57741e721aa08f1"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c5e4c7a0f7a2587fa83c4f59d57741e721aa08f1", @"/Views/Tick/Game.cshtml")]
...
#line 96 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Tick\Game.cshtml"
                    Write(ViewBag.time);
			...
			success: function (result) {
				...
				if (result != ""NotFinished"") {
					...
					if (isfin) {
						...
						$(""#msg"").empty();
						$(""#msg"").a");
            WriteLiteral("ppend(result);\r\n\t\t\t\t\t\tisfin = false;\r\n\t\t\t\t\t\t$(\"#time\").empty();\r\n\t\t\t\t\t\t$(\"#timeE\").empty();\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t});\r\n\r\n\t\t//$.ajax({\r\n\t\t//\ttype: \"GET\",\r\n\t\t//\turl: \"/Game/Stats\",\r\n\r\n\t\t//\tsuccess: function (result) {\r\n\t\t\t\t//\r\n\t\t//\t\tfor (var i = 0; i < ");
            EndContext();
            BeginContext(3782, 9, false);
#line 187 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Tick\Game.cshtml"
                                 Write(ViewBag.i);

#line default
#line hidden
            EndContext();
            BeginContext(3791, 405, true);
            WriteLiteral(@" ; i++) {
		//			$(""#0-"" + i).empty();
...
#line 206 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Tick\Game.cshtml"
                                                            Write(ViewBag.Link);

#line default
#line hidden
            EndContext();
            BeginContext(4209, 886, true);
            WriteLiteral(@""");
					$(""#Promo"").empty();
					$(""#content"").empty();
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "e63038cb44464f25a04321e9e1b3d2ae", async() => {
            }
            );
