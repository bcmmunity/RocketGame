#pragma checksum "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Tick\Game.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5b05ae2d9a804f40bd573f5be409906c4d3f8c0c"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5b05ae2d9a804f40bd573f5be409906c4d3f8c0c", @"/Views/Tick/Game.cshtml")]
...
#line 11 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Tick\Game.cshtml"
                                 Write(ViewBag.Promo);
...
#line hidden
            ...
            WriteLiteral("\r\n\t\t\t\t\t</th>\r\n\t\t\t\t</tr>\r\n");
            EndContext();
#line 41 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Tick\Game.cshtml"
			}
...
#line 50 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Tick\Game.cshtml"
                Write(ViewBag.time);
		...
		if (total != 0) {
            ...
            if (total > 0) {
                ...
                if (total % 60 > 9)
                    ...
                    $(""#time"").append(""| До конца такта: "" + Mat");
            WriteLiteral("h.floor(total / 60) + \":0\" + total % 60);\r\n            }\r\n            else {\r\n                $(\"#time\").empty();\r\n                $(\"#time\").append(\"| До конца такта: 00:00\");\r\n            }\r\n\t\t}\r\n\t\telse {\r\n\t\t\ttotal = 60 * ");
            EndContext();
            BeginContext(2240, 12, false);
#line 108 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Tick\Game.cshtml"
                    Write(ViewBag.time);

#line default
#line hidden
            EndContext();
            BeginContext(2252, 1077, true);
            WriteLiteral(@";
...
");
            WriteLiteral("            }\r\n\t\t}\r\n\t\telse {\r\n\t\t\ttotalE = Math.floor(");
            EndContext();
            BeginContext(3330, 13, false);
#line 139 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Tick\Game.cshtml"
                           Write(ViewBag.timeE);

#line default
#line hidden
            EndContext();
            BeginContext(3343, 1452, true);
            WriteLiteral(@");
...
#line 209 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Tick\Game.cshtml"
                                 Write(ViewBag.i);

#line default
#line hidden
            EndContext();
            BeginContext(4805, 405, true);
            WriteLiteral(@" ; i++) {
		//			$(""#0-"" + i).empty();
...
#line 228 "C:\Users\Никита\Desktop\RocketGame\RocketGame\Views\Tick\Game.cshtml"
                                                            Write(ViewBag.Link);

#line default
#line hidden
            EndContext();
            BeginContext(5223, 940, true);
            WriteLiteral(@""");
					$(""#Promo"").empty();
					$(""#content"").empty();
...
");
            EndContext();
            BeginContext(6163, 45, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "324fd4f39bb645029e063c769fb9e1ae", async() => {
            }
            );
